...
export const products = [
  {
    ...
    name: "Akai Plaid Shirt",
    description:
      "A lightweight, Cropped length with a relaxed silhouette. A Bold plaid pattern with a functional chest pocket. 96% cotton, 4% spandex. Breathable.",
    price: 100,
  ...
  {
    _id: crypto.randomUUID(),
    name: "Mens  Fashion Cargo Pants",
    description:
      "A heavy-duty, cargo pants with a comfortable, relaxed silhouette. 100% cotton.  Latest and Flexible Design",
    price: 220,
  ...
  {
    _id: crypto.randomUUID(),
    name: "Men super styled Pure Cotton  long-sleeve shirt",
    description:
      "A lightweight, usually knitted, pullover shirt, close-fitting and with a round neckline and long sleeves, worn as an outer garment.",
    price: 110,
    image: [p_img4],
    category: "Men",
    subCategory: "Topwear",
  ...
  {
    _id: crypto.randomUUID(),
    name: "Women Double coat Jacket",
    description:
      "A lightweight, usually knitted, pullover shirt, close-fitting and with a round neckline and long sleeves, worn as an outer garment.",
    price: 130,
    image: [p_img5, p_img5_1],
    category: "Women",
    subCategory: "Topwear",
    sizes: ["M", "L", "XL"],
    date: "02-03-2025",
